...
export default function PrivacyPage() {
  return <main>
    ...
    <section className="section"><div className="container legal-content">
      ...
      <h2>Finalidade</h2><p>Esses dados são utilizados para responder à solicitação, apresentar informações disponíveis sobre cursos e informar as etapas seguintes do atendimento.</p>
      <h2>Compartilhamento e responsabilidade institucional</h2><p>Quando o interesse envolver uma instituição parceira, os dados poderão ser utilizados para encaminhar o atendimento relacionado àquela oferta. A equipe IBESC realiza o suporte acadêmico de todos os cursos; oferta, regras acadêmicas e certificação permanecem sob responsabilidade da instituição indicada em cada formação.</p>
