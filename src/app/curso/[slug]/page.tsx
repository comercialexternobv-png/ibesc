...
export default async function CoursePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const highlights = c.highlights || (isGrad ? ['Formação acadêmica da instituição responsável', 'Catálogo oficial para consulta', 'Suporte acadêmico IBESC'] : isTecnico ? ['Formação técnica', 'Atendimento IBESC', 'Orientação sobre matrícula e próximos passos'] : [isPost ? 'Modalidade digital' : 'Formação profissional', `Oferta pela ${institutionLabel}`, 'Suporte acadêmico IBESC']);
  ...
  const responsibilityItems = own
    ...
    : [
      ['Responsabilidade institucional', `${institutionLabel} responde pela formação, pelas regras acadêmicas e pela oferta oficial.`],
      ['Suporte acadêmico IBESC', 'A equipe IBESC realiza o suporte acadêmico, presta atendimento e orienta o canal adequado para avançar.'],
  ...
  const faqItems = [
    ['Quem oferece o suporte acadêmico?', 'O suporte acadêmico de todos os cursos é realizado pela equipe do IBESC.'],
    ['Quem responde pela oferta e certificação?', own ? institutionLabel : `${institutionLabel} responde pela oferta, pelas regras acadêmicas e pela certificação desta formação.`],
